//
//  CompoundTagsViewController.swift
//  SearchPubChem
//
//  Created by Jae Seung Lee on 5/26/21.
...
protocol CompoundTagsViewControllerDelegate: AnyObject {
...
class CompoundTagsViewController: UIViewController {
    ...
    @IBAction func resetTag(_ sender: UIBarButtonItem) {
...
extension CompoundTagsViewController: UICollectionViewDelegate, UICollectionViewDataSource {
